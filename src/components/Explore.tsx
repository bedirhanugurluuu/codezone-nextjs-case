            ...
            <div className="mb-8 flex justify-between items-center">
              ...
              <div className="content-area-header flex items-center gap-4">
                <button 
                  ...
                  className="p-2 text-white hover:text-yellow-500 transition-colors cursor-pointer hidden md:block"
                >
                ...
                <button 
                  ...
                  className={`p-2 transition-colors cursor-pointer ${gridView === 'single' ? 'text-yellow-500' : 'text-white hover:text-yellow-500'}`}
                >
